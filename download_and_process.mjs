...
const COUNTRIES = {
  ...
  'romania':         { name: 'Romania',        flag: '🇷🇴', match: 'romania' },
  'australia':       { name: 'Australia',      flag: '🇦🇺', match: 'australia' },
  'india':           { name: 'India',          flag: '🇮🇳', match: 'india' },
  'portugal':        { name: 'Portugal',       flag: '🇵🇹', match: 'portugal' },
  'morocco':         { name: 'Morocco',        flag: '🇲🇦', match: 'morocco' },
  'switzerland':     { name: 'Switzerland',    flag: '🇨🇭', match: 'switzerland' },
  'ireland':         { name: 'Ireland',        flag: '🇮🇪', match: 'ireland' },
  'netherlands':     { name: 'Netherlands',    flag: '🇳🇱', match: 'netherlands' },
  'poland':          { name: 'Poland',         flag: '🇵🇱', match: 'poland' },
  'russia':          { name: 'Russia',         flag: '🇷🇺', match: 'russia' },
  'bulgaria':        { name: 'Bulgaria',       flag: '🇧🇬', match: 'bulgaria' },
  'norway':          { name: 'Norway',         flag: '🇳🇴', match: 'norway' },
  'sweden':          { name: 'Sweden',         flag: '🇸🇪', match: 'sweden' },
  'argentina':       { name: 'Argentina',      flag: '🇦🇷', match: 'argentina' },
  'finland':         { name: 'Finland',        flag: '🇫🇮', match: 'finland' },
  'mexico':          { name: 'Mexico',         flag: '🇲🇽', match: 'mexico' },
  'austria':         { name: 'Austria',        flag: '🇦🇹', match: 'austria' },
  'brazil':          { name: 'Brazil',         flag: '🇧🇷', match: 'brazil' },
  'czech-republic':  { name: 'Czech Republic', flag: '🇨🇿', match: 'czech' },
  'denmark':         { name: 'Denmark',        flag: '🇩🇰', match: 'denmark' },
  'new-zealand':     { name: 'New Zealand',    flag: '🇳🇿', match: 'new-zealand' },
  'japan':           { name: 'Japan',          flag: '🇯🇵', match: 'japan' },
};
